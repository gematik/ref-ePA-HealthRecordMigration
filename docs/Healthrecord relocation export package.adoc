...
Versionen:
1.1.0
  - Verwendungszwecke Forschungsdaten ergänzt
1.0.1
  - 'insurantid' zu 'insurantId' in entitlements jwt geändert
  - Hinweis zu Befugnis EU-Zugriff (NCPeH) ergänzt 
(1.0.0) 
  - epA-release 3.0.5 (2025-02-28)
////
