...
|1.1.4
|Keine Reihenfolge der Medication Ressourcen im Zip-File mehr vorgegeben und redaktionelle Korrekturen
|===
...
Die Patient-Ressourcen werden dabei im Format JSON als eine Datei abgelegt. Diese Datei beinhaltet alle versionierten Patient-Ressourcen vollständig in einem History-Bundle. Der Dateiname ist P_000000.json.
